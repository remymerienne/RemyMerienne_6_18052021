export const changeMediaByClick = (data, mediaInLightBox) => {
  ...
  uiNavButton.forEach(element => {
    ...
    element.addEventListener('click', (e) => {
      ...
      if (e.target.className == 'fas fa-chevron-right box-button') {

        mediaPosition = mediaPosition === allMedia.length - 1 ? 0 : mediaPosition + 1;
        mediaInLightBox = allMedia[mediaPosition];

      } else if (e.target.className == 'fas fa-chevron-left box-button') {
